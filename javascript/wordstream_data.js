...
<<<<<<< HEAD
    let removeWords = ["iot", "internet", "things", "--","can", "will", "new", "hn", "data", "ask","pdf", "10", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020",
                        ...
                        "whats","show","application","solution","solutions","software","engine", "guide","technology"];
=======
    let removeWords = ["iot", "internet", "things", "--","can", "will", "new", "hn", "ask","pdf", "10", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020"];
    let phrases = ["Big Data", "Open Source"];
>>>>>>> 5bf3413e8ccf0e37a66f274d5bf3dad4892e6b91
    ...
    rawData.forEach(d => {
        ...
        //Reserve the phrase
        phrases.forEach((p, i)=>{
            let startIdx = d.title.toLowerCase().indexOf(p.toLowerCase())
            if(startIdx>=0){
